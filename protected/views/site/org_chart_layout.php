  ...
  div.node
  {
    ...
    <div class="topbar">
    <a href="<?php echo Yii::app()->request->baseUrl; ?>/pmsuser/index.php?r=Organization_flow"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float: right;margin-top: 13px;margin-right: 13px;color: black;')); ?></a><br><br>
