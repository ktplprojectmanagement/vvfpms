                            ...
                            $.ajax({
                                ...
                                {                              
                                    if (data == "success")
                                    {
                                        ...
                                        window.location.href = base_url+'/index.php?r=Setgoals';
                                        //location.reload();
                                    }
                       ...
                       // alert($('.target_value').find(':selected').val());
                        var base_url = window.location.origin;
                         $.ajax({
                                ...
                                datatype : 'json',
                                data : selected_unit,
                                url : base_url+'/index.php?r=Setgoals/gettarget_value2',
                                success : function(data)
                                { 
                                    //alert(data);
var detail = jQuery.parseJSON(data);
...
function save_detail_pdf()
                { 
                    ...
                    datatype : 'html',
                    data : data,
                    url : base_url+'/index.php?r=Checkattach/check_goal_idp',
                    success : function(data)
                    {
