                ...
                <div class="page-head">
                    <div class="container">
                        ...
                        <div class="page-title">
                            <h1>Quater1 Review Employee List </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->                       
                        <!-- END PAGE TOOLBAR -->
                ...
                <div class="page-content">
                    <div class="container">                       
							...
							<td> <?php echo $kpi_emp_data_aprv[$i]['0']['Department']; ?> </td>
                                                            <td> <?php  if(isset($kpi_data_aprv[$i]['0']['q1_KRA_final_status']) && $kpi_data_aprv[$i]['0']['q1_KRA_final_status']!='' && $kpi_data_aprv[$i]['0']['q1_KRA_final_status']!='Pending') { ?> <lable style="color: rgb(18, 95, 38);"><?php echo "Completed";?></lable> <?php }else{ ?><lable style="color: red;"><?php echo "Pending";  ?></lable><?php } ?> </td>
                                                            <td>
...
<?php 
            ...
            //                                                     ));
                        $form=$this->beginWidget('CActiveForm', array(
                                                                    // 'id'=>'contact-form',
                                                                    'enableClientValidation'=>true,
                                                                    'action' => array('index.php/Quater1/midreview_emp_data'),
                                                                ));
                                                                 ?>
