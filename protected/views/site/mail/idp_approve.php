...
<div class="container">
  <div class="logo">
<img src="http://52.172.210.251/vvf.kritva.in/Logo.png" alt="VVF" style="max-width: 8%;">
<hr >
  </div>
  Dear <label><?php if(isset($mail_data['0']['Emp_fname'])) { echo $mail_data['0']['Emp_fname']; }?></label>,<br/>

 I have reviewed and approved your IDP and is as attached herewith.</span> Kindly login to PMS portal through link below, review the same and take necessary action if required.<br/>

<span> Click on the link below to check the status:<br>
  <a href="http://52.172.210.251/vvf.kritva.in/index.php/Login">https://vvf.kritva.in/index.php/Login</a>
