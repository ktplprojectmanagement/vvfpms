...
<hr >
  ...
  Dear <label><?php if(isset($mail_data1['0']['Emp_fname']) && isset($mail_data1['0']['Emp_lname'])) { echo $mail_data1['0']['Emp_fname'].' '.$mail_data1['0']['Emp_lname']; }?></label>,<br/>
   ...
   Please be informed the final year goalsheet for year <label><?php echo date('Y',strtotime('-1 year')).'-'.date('Y'); ?></label>  has been submitted by me and  which is ready for your approvals.</span> Kindly login to PMS Online to review the same and for further actions.<br/>
