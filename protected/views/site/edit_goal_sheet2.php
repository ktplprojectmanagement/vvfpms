...
var specialElementHandlers = {
                    ...
                    datatype : 'html',
                    data : data,
                    url : base_url+$("#basepath").attr('value')+'/index.php?r=Checkattach/check_view1',
                  ...
                  var data1 = {
                    ...
                    datatype : 'html',
                    data : data1,
                    url : base_url+$("#basepath").attr('value')+'/index.php?r=Checkattach/check_idp',
                    success : function(data)
                    {
                        //alert("dsfdsf");
                    }
...
if($("#term_condition:checked").val() != 'term_condition')
                                            ...
                                            $.ajax({
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+$("#basepath").attr('value')+'/index.php?r=Setgoals/update_emp_kpi_all',
                                                success : function(data)
                                                {
//alert(data);
              ...
              $("body").on('click','.add_program',function(){
                   ...
                   var data = {
                    ...
                    $.ajax({
                            ...
                            'datatype' : 'html',
                            'data' : data,
                            'url' : base_url+$("#basepath").attr('value')+'/index.php?r=IDP/add_program',
                            success : function(data)
                            {
                              $("#new_topic").html(data);
              ...
              $("body").on('click','.del_extra_program',function(){
                ...
                var detail_data = {
                            ...
                            $.ajax({
                                ...
                                'datatype' : 'html',
                                'data' : detail_data,
                                'url' : base_url+$("#basepath").attr('value')+'/index.php?r=IDP/del_extra_program',
                                success : function(data)
                                {
                                  location.reload();
                                    // $(".row_rfrsh").load(location.href + ".row_rfrsh");
               ...
               $("body").on('click','.del_extra_program_list',function(){
                ...
                var detail_data = {
                            ...
                            $.ajax({
                                ...
                                'datatype' : 'html',
                                'data' : detail_data,
                                'url' : base_url+$("#basepath").attr('value')+'/index.php?r=IDP/del_extra_program_list',
                                success : function(data)
                                {
                                    //alert(data);
                                 location.reload();
