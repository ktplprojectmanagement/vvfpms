                                                               ...
                                                               // print_r($model);die();
                                                                ...
                                                                ?>                                                                
                                                                    <tr class="odd gradeX">
                                                                        ...
                                                                        <td>
                                                                            <a style="text-decoration: none;" href="<?php echo Yii::app()->createUrl('index.php/MIS/Mis_update', array('u_id' => $row['u_id']));?>"><span class="label label-sm label-warning" style="background-color:#337AB7;"> Check </span></a>
                                                                        </td>
                                                                    </tr>
                                                                  <?php
                                                                    }
