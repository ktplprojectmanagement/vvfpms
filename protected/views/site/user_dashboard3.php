...
<script type="text/javascript">
        $(function(){
         $(".chk_team_setgol_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+$("#basepath").attr('value')+'/index.php?r=User_dashboard3/teamSetgoalstatus',
         ...
         $(".chk_team_idp_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+$("#basepath").attr('value')+'/index.php?r=User_dashboard3/teamIdpstatus',
            success : function(data)
            {
               // alert(data);
                var table = $('#sample_editable_1').DataTable();
          ...
          $(".chkteam_mid_stat").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+$("#basepath").attr('value')+'/index.php?r=User_dashboard3/teamMidstatusget',
            success : function(data)
            {
                //alert(data);
                var table = $('#sample_editable_1').DataTable();
...
var data = {
        ...
        $(".chkteam_mididp_stat").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+$("#basepath").attr('value')+'/index.php?r=User_dashboard3/teamMidIdpstatusget',
            success : function(data)
            {
                //alert(data);
                var table = $('#sample_editable_1').DataTable();
 ...
 $(".chk_team_yearEnd_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+$("#basepath").attr('value')+'/index.php/User_dashboard3/TeamYearEndstatus',
            success : function(data)
            {
                //alert(data);
                var table = $('#sample_editable_1').DataTable();
          ...
          $(".chk_team_yearEndIDP_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+$("#basepath").attr('value')+'/index.php/User_dashboard3/TeamYearEndsIDPtatus',
            success : function(data)
            {
             // alert(data);
                var table = $('#sample_editable_1').DataTable();
