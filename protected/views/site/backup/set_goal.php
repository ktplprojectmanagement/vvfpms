                                ...
                                $('.format_detail').change(function(){
                                    ...
                                    else
                                    {
                                        ...
                                        if(selected_unit != 'Date')
                                        {
                                            ...
                                            $(".target_value4"+id_value[1]).datepicker("destroy");
                                            $(".target_value5"+id_value[1]).datepicker("destroy");    
                                            $("#unit_value-"+id_value[1]).attr('readonly');
                                            $(".target_value1"+id_value[1]).removeAttr('readonly');
                                            $(".target_value2"+id_value[1]).removeAttr('readonly');
                                            $(".target_value3"+id_value[1]).removeAttr('readonly');
                                            $(".target_value4"+id_value[1]).removeAttr('readonly');
                                                ...
                                                <div class="portlet-body">
                                                    ...
                                                    <tr>
                                                           ...
                                                           $format_list = array('Select' => 'Select','Days' => 'Days','Date' => 'Date','Units' => 'Units','Weight' => 'Weight','Ratio' => 'Ratio','Value' => 'Value','Percentage' => 'Percentage');
                                                            $wtage = array('15'=>'15','20'=>'20','30'=>'30','40'=>'40','50'=>'50');
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="numeric">
                                                                ...
                                                                for ($i=0; $i < count($kpi_data_data); $i++) { 
                                                                ?>
                                                                <tr><td><?php echo $kpi_list_target[$i];echo""; ?></td></tr>
                                                                <?php
                                                                    }
                                                            ?>  
                                                            </table>  
     ...
     ?>"><i class="fa fa-pencil fa-fw" title="Delete" aria-hidden="true"></i></a><a href="<?php echo $this->createUrl('Setgoals/kpi_del', array('KPI_id' => $row['KPI_id']));
     ?>"><i class="fa fa-trash-o del_kpi" style="cursor: pointer;" id="KPI_id-<?php echo $row['KPI_id']; ?>" title="Delete" aria-hidden="true"></i></a></td>                                                           
                                                        </tr>                                                       
                                                    </tbody>
                                                </table>
                                            </div>
                ...
                function send_notification()
                {
                    ...
                    else
                    {
                        ...
                        if (total>100) 
                        {
                            get_notify("Total for goal score should be 100.");
                        }
                        else
                        {                            
                            $("#static").modal('show');
