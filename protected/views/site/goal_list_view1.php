                       ...
                       <?php if (isset($approved_list)) { ?>
							...
							if(isset($kpi_data) && count($kpi_data)>0) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <?php if(isset($kpi_data[$cnt]['set_status']) && $kpi_data[$cnt]['set_status'] == 'Pending') { ?><lable style="color:red"><?php echo $kpi_data[$cnt]['set_status']; ?></lable><?php }else if(isset($kpi_data[$cnt]['set_status']) && $kpi_data[$cnt]['set_status'] == 'Approved') { ?><lable style="color:green"><?php echo $kpi_data[$cnt]['set_status']; ?></lable><?php } ?> </td>
                                                                <td>
<?php 
