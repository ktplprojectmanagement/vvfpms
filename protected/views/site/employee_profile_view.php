                            ...
                            <div class="page-sidebar">
                                <nav class="navbar" role="navigation">
                                    ...
                                    <ul class="nav navbar-nav margin-bottom-35">
                                        <li class="active">
                                            <a href="<?php echo Yii::app()->request->baseUrl; ?>/pmsuser/index.php?r=Newemployee/employee_master">
                                        ...
                                        <li>
                                            <a href="<?php echo Yii::app()->request->baseUrl; ?>/pmsuser/index.php?r=Approve_goal/">
