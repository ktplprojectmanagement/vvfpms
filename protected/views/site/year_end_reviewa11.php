                                   ...
                                   formData.append("Year_end_prog_comments",$('#yearA_prj_stat_comments').val());
                                    ...
                                    $.ajax({
                                        type : 'post',
                                            ...
                                            data : formData,
                                            url : base_url+'/index.php/Year_endreview11/updatereview1',
                            ...
                            $(window).scroll(function()
                            {
                             ...
                             var base_url = window.location.origin;
                              $.ajax({
                                  ...
                                  datatype : 'html',
                                  data : emp_id,
                                  url : base_url+'/index.php/Year_endreview11/final_goal_review',
                                  success : function(data)
                                  {
                                          ...
                                          $("#continue_goal_set").click(function(){
                                              $("#show_spin").show();
                                                  $.ajax({
                                                      type : 'post',
                                                      datatype : 'html',
                                                      url : base_url+'/index.php/Year_endreview11/goalnotification1',
                                                      success : function(data)
                                                      {
                                   ...
                                   formData.append("Year_end_prog_comments",$('#yearA_prj_stat_comments').val());
                                    ...
                                    $.ajax({
                                        type : 'post',
                                            ...
                                            enctype : 'multipart/form-data',
                                            data : formData,
                                            url : base_url+'/index.php/Year_endreview11/updatereview',
                                            success : function(data)
                                            {
                                              jQuery("#static").modal('show');
                                          $("#continue_goal_set").click(function(){
...
var base_url = window.location.origin;
                                    $.ajax({
                                        type : 'post',
                                            datatype : 'html',
                                            data : data,
                                            url : base_url+'/index.php/Year_endreview11/updatereview_delfile1',
                                            success : function(data)
                                            {
 ...
 var base_url = window.location.origin;
                                    $.ajax({
                                        type : 'post',
                                            datatype : 'html',
                                            data : data,
                                            url : base_url+'/index.php/Year_endreview11/updatereview_delfile',
                                            success : function(data)
                                            {
