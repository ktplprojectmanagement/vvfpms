...
if(isset($program_data_result) && count($program_data_result)>0) { echo count($program_data_result);}  ?></label>
...
function save_detail_pdf()
                { 
                    ...
                    {
                        alert(data);
                        location.href = base_url+'/pms/Goalsheet_docs/yearendgoalsheet'+'_'+$("#femp_name").text()+'_'+$("#lemp_name").text()+'2016-2017'+'.pdf'; 
                    }
                    });                 
                }
</script>
