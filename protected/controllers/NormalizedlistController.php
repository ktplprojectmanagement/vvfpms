<?php
	...
	class NormalizedlistController extends Controller
	{
	...
	public function actionIndex()
	{
		...
		$normalize_rating =new NormalizeRating1Form;
		$IDPForm =new IDPForm;
...
//echo "asdsa";die();
		...
		$this->render('//site/normalize_layout_view_list',array('model'=>$model,'bu_flag'=>$bu_flag,'cluster_flag'=>$cluster_flag,'employee_list'=>$employee_list,'kra_result'=>$kra_result,'employee_list_data'=>$employee_list,'appraiser_list'=>$appraiser_list_data,'diff_Department'=>$diff_Department,'head_branch_data'=>$head_branch_data,'diff_cluster'=>$diff_cluster,'diff_reporting_head'=>$diff_reporting_head,'dep_head_data'=>$dep_head_data,'normalize_rating_data'=>$normalize_rating_data,'IDPForm_data'=>$IDP_data,'kpi_data_pending'=>$kpi_data_pending,'pending_list'=>$pending_list1));
