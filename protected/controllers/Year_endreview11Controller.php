...
class Year_endreview11Controller extends Controller
{
...
//print_r($kpi_data);die();
		...
		$this->render('//site/year_end_reviewa11',array('program_data_result'=>$program_data_result,'kpi_data' => $kpi_data,'emp_data' => $emp_data,'mgr_data'=>$mgr_data,'IDP_data'=>$IDP_data,'designation_flag'=>$designation_flag));
