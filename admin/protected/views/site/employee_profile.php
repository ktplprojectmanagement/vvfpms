                                  ...
                                  <div class="portlet box " style='border:1px solid #337ab7;'  id='new_kra'>
                                    ...
                                    <!--<div class="form-group">
                                       <label class="control-label col-md-3">Select Cluster Appraiser<span class="required"> * </span></label>
                                         ...
                                         <?php 
                                         $cluster_name_models = new ClusterForm();
                                         $records = $cluster_name_models->get_list('cluster_appraiser');
                                         $status1 = '';
                                        ...
                                        // print_r($employee_data['0']['cluster_appraiser']);die();
                                         $Cadre_id = array();                                 
                                       ...
                                       <label class="control-label col-md-3">Cluster Appraiser<span class="required"> * </span></label>
                                        ...
                                        if (isset($Reporting_officer_data[$l]['0']['Emp_fname']) && isset($Reporting_officer_data[$l]['0']['Emp_lname']) && $Reporting_officer_data[$l]['0']['Email_id']) {
                                           $Cadre_id[$Reporting_officer_data[$l]['0']['Email_id']] = $Reporting_officer_data[$l]['0']['Emp_fname']." ".$Reporting_officer_data[$l]['0']['Emp_lname'];
                                            ...
                                            $list = array('Email_id');
                                            $data = array($employee_data['0']['cluster_appraiser']);
                                            $Reporting_officer_data = $reporting_list->get_employee_data1($where,$data,$list);

                                            $status1 = '';
                                            $status1[$employee_data['0']['cluster_appraiser']] = array('selected' => true);
                                            if($employee_data['0']['cluster_appraiser']=="" ||$employee_data['0']['cluster_appraiser']=="undefined"){
                                            echo CHtml::dropDownList('Reporting_officer1_id','',$Cadre_id,$htmlOptions=array('class'=>'form-control cluster_appraiser','options' => $status1,'disabled'=> "true",'empty'=>'Select'));
                                      }
                                        else{
                                            echo CHtml::dropDownList('Reporting_officer1_id','',$Cadre_id,$htmlOptions=array('class'=>'form-control cluster_appraiser','options' => $status1,'disabled'=> "true")); 
                                          }
                                       ...
                                       <label class="control-label col-md-3">BU Head<span class="required"> * </span></label>
                                        ...
                                        if (isset($Reporting_officer_data[$l]['0']['Emp_fname']) && isset($Reporting_officer_data[$l]['0']['Emp_lname']) && $Reporting_officer_data[$l]['0']['Email_id']) {
                                           $Cadre_id[$Reporting_officer_data[$l]['0']['Email_id']] = $Reporting_officer_data[$l]['0']['Emp_fname']." ".$Reporting_officer_data[$l]['0']['Emp_lname'];
                                            ...
                                            echo CHtml::dropDownList('Reporting_officer1_id','',$Cadre_id,$htmlOptions=array('class'=>'form-control bu_head','options' => $status1,'disabled'=> "true",'empty'=>'Select'));
                                      }
                                        else{
                                       ...
                                       <label class="control-label col-md-3">Date Of Retirement<span class="required"> * </span></label>
                                        ...
                                        <?php 
                                            ...
                                            if (isset($employee_data['0']['retire_date'])) {  $reporting_1_effective_date = $employee_data['0']['retire_date']; }else { $reporting_1_effective_date = ''; }
                                             echo CHtml::textField('effective_date',$reporting_1_effective_date,$htmlOptions=array('class'=>"form-control joining_date retire_date",'disabled'=> "true")); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group allow_kra2" <?php if($employee_data['0']['reporting_1_effective_date']=="") {?>style="display:none"<?php } ?>>        
                                       ...
                                       <?php 
                                            ...
                                            if (isset($employee_data['0']['reporting_1_effective_date'])) {  $reporting_1_effective_date = $employee_data['0']['reporting_1_effective_date']; }else { $reporting_1_effective_date = ''; }
                                             echo CHtml::textField('effective_date',$reporting_1_effective_date,$htmlOptions=array('class'=>"form-control joining_date",'disabled'=> "true")); ?>
                                        </div>
                                    </div>
                                     <div class="form-group">
...
<a href='<?php echo Yii::app()->request->baseUrl; ?>/index.php/Newemployee/employee_master'><?php  
                                                ...
                                                ?></a>   
                                        <?php  
                                                echo CHtml::button('Edit',array('class'=>'btn green','style'=>'float:right;margin-right: 596px;background-color: rgb(51, 122, 183);','onClick'=>'js:update_emp_profile1()','id'=>'edit_profile1'));  
                                                ?>  
 <?php  
                                                echo CHtml::button('Update',array('class'=>'btn green','style'=>'float:right;margin-right: 596px;background-color: rgb(51, 122, 183);display:none','onClick'=>'js:update_emp_profile()','id'=>'edit_profile'));  
                                                ?> 
                                         <?php                                  
...
function update_emp_profile1(){
$("#edit_profile1").css('display','none');
...
form_data.append("new_kra_till_date",$(".main_repoting_officer").find(':selected').val());
                                           // form_data.append("new_kra_till_date",$(".new_kra_till_date").find(':selected').val());
                                            ...
                                            form_data.append("bu_head_email",$('#bu_email1').val());
                                            form_data.append("plant_head_name",$('#plant_head').find(':selected').text());
                                            form_data.append("plant_head_email",$('#plant_email1').val());
...
form_data.append("retire_date",$('.retire_date').val());
                                           ...
                                           //alert($(".cluster_appraiser").find(':selected').val());
