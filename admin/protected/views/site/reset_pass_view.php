...
window.setTimeout(function() {
    window.location.href = base_url+$("#basepath").attr('value')+'/admin/index.php/Adminlogin';
}, 1000);  
                                //window.location.href = base_url+$("#basepath").attr('value')+'/admin/index.php?r=Adminlogin';
                            }
