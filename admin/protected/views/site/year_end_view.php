        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php if(isset($master_apr) && $master_apr == 1) {?><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Midreview"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;width: 93px;')); ?></a><br><br><?php } ?>
                         <?php if(isset($master_apr) && $master_apr == 2) {?><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Subordinate/yearend_reviewb"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;width: 93px;')); ?></a><br><br><?php } ?>
                       <?php 
