                    ...
                    <div class="modal-dialog">
                        <div class="modal-content"> 
                         <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/IDP/IDP_Mid_approvegoal_list"><button type="button" class="btn border-blue-soft" id="redirect_to_master">OK</button></a>
                                </div> 
                        </div>
                    </div>
                   </div>
...
<div class="col-md-12" style="margin-top: 58px;">
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/IDP/IDP_Mid_approvegoal_list"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;margin-top: -64px;
}')); ?></a></div>
