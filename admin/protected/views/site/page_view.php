...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/assets/layouts/layout3/css/layout.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?><?php echo Yii::app()->request->baseUrl; ?><?php echo Yii::app()->request->baseUrl; ?>/assets/global/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?><?php echo Yii::app()->request->baseUrl; ?>/assets/global/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
