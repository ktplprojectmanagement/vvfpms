...
var base_url = window.location.origin;
                           $.ajax({
                                ...
                                'datatype' : 'html',
                                'data' : data,
                                'url' : base_url+'/admin/index.php?r=Login_demo/check',
                                success : function(data)
                                {
                                
                                        if (data == '1')
                                        {
                                            window.location.href = base_url+"/admin/index.php/Setgoals";
                                        }
                                        else if (data == '0')
                                        {
                                            window.location.href = base_url+"/admin/index.php/Setgoals/approvegoal_list";
                                        }
                                        else if (data == '2')
                                        {
                                            window.location.href = base_url+"/admin/index.php/Midreview";
                                        }
                                        else if (data == '3')
                                        {
                                            window.location.href = base_url+"/admin/index.php/setbyemployee";
                                        }
                                        else if (data == '4')
                                        {
                                            window.location.href = base_url+"/admin/index.php/IDP";
                                        }
                                        else if (data == '5')
                                        {
                                            window.location.href = base_url+"/admin/index.php/IDP_approvegoal_list";
                                        }
                                        else if (data == '6')
                                        {
                                            window.location.href = base_url+"/admin/index.php/Midyear_subordinate_idp1";
                                        }
                                        else if (data == '7')
                                        {
                                            window.location.href = base_url+"/admin/index.php/IDP/IDP_Mid_approvegoal_list";
                                        }
                                        else if (data == 'Valid')
                                        {
                                            window.location.href = base_url+"/admin/index.php/User_dashboard";
                                        }                                        
                                        else if(data == 'already_login')
                                        {
                                            //$("#already_login").text("User already login");
                                            window.location.href=base_url+'/admin/index.php/Login';
                                        }
                                        else if(data == 'reset_pending')
                                        {
                                            window.location.href=base_url+'/admin/index.php/Reset_password/Index/';
                                        }
                                        else
                                        {
                ...
                if (email_string.test($('.email_reset').val())) 
                {
                    ...
                    var base_url = window.location.origin;
                       ...
                       $.ajax({
                        ...
                        datatype : 'html',
                        data : data,
                        url : base_url+'/admin/index.php?r=Login/reset_password',
                        success : function(data)
                        { 
