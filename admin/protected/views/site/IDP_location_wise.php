...
padding-top: 10px;
 ...
 <div class="page-container">
                    ...
                    <div class="container">                       
                        ...
                        <div id="err" style="display: none"></div>
                                    ...
                                    <div class="portlet light form-fit ">
                                        ...
                                        <div class="portlet-title">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject  bold uppercase" style="color:#337ab7;font-size: 12px;">Part A: Development through Instructor led training in Classroom</span><br>
                            ...
                            <br><lable style="color: red">**</lable>Mandatory for employees working at locations covered by the certifications</span>
                                            ...
                                            ?>                                        
                                             <tr class="error_row_chk"> 
                                               <!--  <td><?php echo $i; ?></td>    -->                
                                                ...
                                                <?php if($program_data_result[$i]['need'] == 2 && $program_data_result[$i]['location'] != '' && $program_data_result[$i]['location'] != 'undefined') { ?><label id = 'complusory_prg<?php echo $i; ?>' style="color: red"><?php echo $program_data_result[$i]['location']; ?></label><?php } ?>
                                                </td>
                                                ...
                                                else
                                                {
                                                    ...
                                                    echo CHtml::textField('program_cmd',$cmnt,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 program_cmd",'id'=>'program_cmd-'.$i));
                                                ?> </td>
                                            </tr>
                                    <?php 
                                       }
                                    ...
                                    ?>
                                    <label id="compulsory_id"><?php echo '5;6;11;12'; ?></label>
                                    </tbody>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                         ...
                                                         echo CHtml::textField('topic1',$topic,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 topic1")); ?> 
                                                        </div>
                                                        <div class="col-md-2">
                                                            <?php echo CHtml::textField('days_required1',$day,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 days_required1")); ?> 
                                                        </div>
                                                        <div class="col-md-4">
                                                         <?php 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                         ...
                                                         $topic = '';$day = '';$faculty = '';
                                                             ...
                                                             echo CHtml::textField('topic2',$topic,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 topic2")); ?> 
                                                        </div>
                                                        <div class="col-md-2">
                                                            <?php echo CHtml::textField('days_required2',$day,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 days_required2")); ?> 
                                                        </div>
                                                        <div class="col-md-4">
                                                          <?php 
                                                             $reporting_list = new EmployeeForm();
                                                            ...
                                                            echo CHtml::DropDownList('faculty_email_id2','faculty_email_id2',$Cadre_id,array('class'=>'form-control faculty_email_id2','empty'=>'Select','options' => $faculty)); ?>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row" <?php if(isset($designation_flag) && $designation_flag==1) { ?>style="display: block"<?php }else { ?>style="display: none"<?php } ?>>
                                <div class="col-md-12">
                                    <!-- BEGIN PORTLET-->
                                            ...
                                            <form action="#" id="form-username" class="form-horizontal form-bordered">
                                                    <div class="form-group">
                                                      <div class="col-md-12">
                                                        <label class="col-md-12 control-label" style="text-align:left;"><span class="bold" style="color:#337ab7;font-size: 14px;float: left;">
                                                          Note: Part B and Part C are to be filled by only AGM and above employees.<br>
                                                          Part B: Development through developmental relationships</span>
                                                        </label>
                                                      </div>
                                                   </div>
                                                    <div class="form-group">                                                        
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            // echo CHtml::DropDownList('faculty_email_id3','faculty_email_id3',$Cadre_id,array('class'=>'form-control faculty_email_id3','empty'=>'Select','options' => $faculty3)); 
                                                             echo CHtml::textField('faculty_email_id3',$faculty3,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 faculty_email_id3",'id'=>'faculty_email_id3'));
                                                            ?>
                                                          </div>
                                                       <div class="col-md-2">
                                                             <?php 
                                                              ...
                                                              echo CHtml::textField('number_of_meetings3',$meet,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 number_of_meetings3",'id'=>'number_of_meetings3')); ?> 
                                                          </div>
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                       <!--  <label class="control-label col-md-1">2</label> -->
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            echo CHtml::textField('faculty_email_id4',$faculty4,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 faculty_email_id4",'id'=>'faculty_email_id4'));
                                                             ?>
                                                          </div>
                                                       <div class="col-md-2">
                                                           <?php 
                                                          ...
                                                          echo CHtml::textField('number_of_meetings4',$meet,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 number_of_meetings4",'id'=>'number_of_meetings4')); ?> 
                                                          </div>
                                                        <div class="col-md-2">
                                                            <div class="input-group input-medium date date-picker" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                            <?php
                                                                  if (isset($IDP_data['0']['rel_target_date']) && $IDP_data['0']['rel_target_date']!='') { $rel2 = explode(';',$IDP_data['0']['rel_target_date']); ?>
                                                                       <input class="form-control target_date4" readonly="" type="text" value="<?php echo $rel2[1]; ?>" id="target_date4">
                                                                   <?php }
                                                                    else
                                                                    { ?>
                                                                       <input class="form-control target_date4" readonly="" type="text"  id="target_date4">
                                                                 <?php   }
                                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                      <div class="col-md-12">
                                                        <label class="col-md-12 control-label" style="text-align:left;">
                                                          <span class="bold" style="color:#337ab7;font-size: 14px;float: left;">Part C: Development through action learning projects
                                                        </span></label>
                                                      </div>
                                                        ...
                                                        <div class="input-group input-medium date date-picker target_end_date" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                                <?php
                                                                  if (isset($IDP_data['0']['project_end_date'])) { ?>
                                                                       <input class="form-control" readonly="" type="text" value="<?php echo $IDP_data['0']['project_end_date']; ?>" id="target_end_date">
                                                                   <?php }
                                                                    else
                                                                    { ?>
                                                                       <input class="form-control" readonly="" type="text" id="target_end_date">
                                                                 <?php   }
                                                                ?>
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        echo CHtml::textField('project_scope',$project_scope,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 project_scope")); ?> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        echo CHtml::textField('project_exclusion',$project_exclusion,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 project_exclusion")); ?> 
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <form action="#" id="form-username" class="form-horizontal form-bordered">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        echo CHtml::textArea('deliverables',$Project_deliverables,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 project_deliverables",'style'=>'max-width: 846px;width: 936px;height: 214px;max-height: 67px;')); ?> 
                                                    </div>
                                                </div>
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                       ...
                                                       echo CHtml::textField('exp',$expected,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 learn_from")); ?>  
                                                    </div>
                                                </div>
                            ...
                            <div class="row">                             
                                <div class="col-md-offset-3 col-md-9">
                                 <?php if(isset($designation_flag) && $designation_flag==1) { ?>
                                 <button type="button" class="btn btn-primary save_data1" style="float: right;">
                                    Save</button>
                                    <?php }else { ?>
                                   <button type="button" class="btn btn-primary save_data" style="float: right;">
                                    Save</button>
                                    <?php } ?>
                                </div>
                            </div>
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/global/plugins/clockface/js/clockface.js" type="text/javascript"></script>
         ...
         <label id = 'company_loc'>Taloja1</label>
         <script type="text/javascript">
             $(function(){
                $(".save_data").click(function(){
                    var chk_cmnts = 0;var chk_cmnts1 = 0;var chk_compl = 0;
                    ...
                    for (var i = 0; i <= $("#total_prog").text(); i++) {
                       if ($("#complusory_prg"+i).text() != '' && $("#complusory_prg"+i).text() != 'undefined')
                        ...
                        else if ($("#complusory_prg"+i).text() == '')
                        {
                           for (var j = 0; j < get_list_value.length; j++) 
                                 {
                                  if(get_list_value[j] == i)
                                  {
                    ...
                    else
                    {
                        ...
                        $.ajax({
                            ...
                            'datatype' : 'html',
                            'data' : detail_data,
                            'url' : base_url+'/pmsuser/index.php?r=IDP/save_data',
                            success : function(data)
                            {
                              ...
                              $("#continue_IDP_set").click(function(){
                                $("#updation_spinner").css('display','block');
                                    ...
                                    'datatype' : 'html',
                                    'data' : detail_data,
                                    'url' : base_url+'/pmsuser/index.php?r=IDP/send_for_approval',
                                    success : function(data)
                                    {
                ...
                $(".save_data1").click(function(){
                    var chk_cmnts = 0;var chk_cmnts1 = 0;var chk_cmnts2 = 0;var chk_compl = 0;
                    var get_list = $("#compulsory_id").text();
                    var get_list_value = get_list.split(';');
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            $.ajax({
                                ...
                                'datatype' : 'html',
                                'data' : detail_data,
                                'url' : base_url+'/pmsuser/index.php?r=IDP/save_data1',
                                success : function(data)
                                {
                                    alert(data);
                                }
