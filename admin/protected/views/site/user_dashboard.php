...
<div id="goal_pending" class="blink_me col-md-6">Your Goal Sheet is pending </div>
                         <div id="idp_pending" style="padding-bottom:10px" class="blink_me col-md-6">Your IDP is pending</div>
...
<div   style="background-color:#fff;">
    <div class="portlet-title col-md-6" id="my_set" >
        <div class="caption " style="">
            <span class="caption-subject  bold uppercase col-md-12" style="font-size:23px;color:#fff;background-color:#4c9ed9"><i class="fa fa-user" aria-hidden="true" style="font-size:25px"></i>&nbsp;&nbsp;My Goalsheet</span>
        </div>
  

<div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 " >
              <div class="col-lg-12" style="font-weight:bold; padding-top:10px;padding-bottom:40px;padding-left:0px;padding-right:0px"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Setgoals">Goalsheet approval status : </a>&nbsp;&nbsp;
...
<!--My IDP status-->
<div class="portlet-title col-md-6" id="my_idp">
  <div class="caption " style="">
...
<div   style="background-color:#fff;">
    <div class="portlet-title col-md-6" id="my_mid" >
        <div class="caption " style="">
...
<div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 " >
              <div class="col-lg-12" style="font-weight:bold; padding-top:10px;padding-left:0px;padding-right:0px"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Midreview/setbyemployee">Mid year review status : </a>&nbsp;&nbsp;
...
<!--My Mid IDP status-->
<div class="portlet-title col-md-6" id="my_mid_idp">
  <div class="caption " style="">
      <i class="icon-cursor font-dark hide"></i>
...
<div  id="team_idp" style="background-color:#fff;">
    <div class="portlet-title col-md-12">
  <div class="caption " style="">
...
<!--Begin my team members Idp-->
<div  id="team_mid" style="background-color:#fff;">
    <div class="portlet-title col-md-12">
  <div class="caption " style="">
...
<!--Begin my team members Idp-->
<div  id="team_mid_idp" style="background-color:#fff;">
    <div class="portlet-title col-md-12">
  <div class="caption " style="">
