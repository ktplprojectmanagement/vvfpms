...
<body lang="en-IN" dir="ltr" id="target">
...
<div title="header">
	<p style="margin-bottom: 0cm; border-top: none; border-bottom: 1.00pt solid #4f81bd; border-left: none; border-right: none; padding-top: 0cm; padding-bottom: 0.14cm; padding-left: 0cm; padding-right: 0cm; letter-spacing: 0.3pt; line-height: 100%">
	<font color="#17365d"><font face="Cambria, serif"><font size="6" style="font-size: 26pt"><font size="5" style="font-size: 18pt">Individual
	Development Plan (WI.CHR.03 F.NO. 1)</font></font></font></font></p>
</div>
<table width="707" cellpadding="7" cellspacing="0" style="page-break-before: always">
	<col width="66">
	<col width="234">
	<col width="71">
	<col width="278">
	<tr valign="top">
		<td width="66" height="32" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p style="margin-bottom: 0cm"><font face="Cambria, serif"><b>Employee</b></font></p>
			<p><font face="Cambria, serif"><b>Name</b></font></p>
		</td>
		<td width="234" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><br/>
				<?php 
		...
		<td width="278" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><br/>
...
<table width="707" cellpadding="7" cellspacing="0">
	...
	<col width="240">
	<tr valign="top">
		<td width="21" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>No</b></font></p>
		</td>
		<td width="307" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
		...
		<td width="240" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	?>
	<tr valign="top">
		<td width="21" height="43" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
...
<table width="707" cellpadding="7" cellspacing="0">
	...
	?>
	<tr valign="top">
		<td width="19" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>No</b></font></p>
		</td>
		<td width="195" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>Relationship</b></font></p>
		</td>
		<td width="213" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>Name of leader</b></font></p>
		</td>
		<td width="81" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>Number of Meetings planned</b></font></p>
		</td>
		<td width="127" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>Target date</b></font></p>
		</td>
	</tr>
	<tr valign="top">
		<td width="19" height="43" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif">1</font></p>
		</td>
		<td width="195" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
    ...
    ?>
	<tr valign="top">
		<td width="19" height="42" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
...
<table width="707" cellpadding="7" cellspacing="0">
	...
	<col width="580">
	<tr valign="top">
		<td width="96" height="42" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><font face="Cambria, serif"><b>Project Title</b></font></p>
		</td>
		<td width="580" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
			<p><br/>
	...
	<tr valign="top">
		<td width="96" height="14" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	<tr valign="top">
		<td width="96" height="22" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	<tr valign="top">
		<td width="96" height="62" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	<tr valign="top">
		<td width="96" height="47" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	<tr valign="top">
		<td width="96" height="211" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	<tr valign="top">
		<td width="96" height="183" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
	...
	<tr valign="top">
		<td width="96" height="136" style="border: 1px solid #00000a; padding-top: 0cm; padding-bottom: 0cm; padding-left: 0.2cm; padding-right: 0.19cm">
 ...
 <script type="text/javascript">
                                           $(function(){
                                            var specialElementHandlers = {
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+'/pmsuser/index.php?r=Checkattach/check_idp',
