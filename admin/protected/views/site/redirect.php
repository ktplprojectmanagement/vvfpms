...
padding-top: 10px;
    ...
    <script type="text/javascript">
        $(function(){
                $("#chart_create").click(function(){
                    var data = {
                        'cluster_name' : $(".get_cluster").find(':selected').val(),
                        'dept_name' : $(".get_dept").find(':selected').val(),
                    };
                    ...
                    $.ajax({
                        ...
                        datatype : 'html',
                        data : data,
                        url : base_url+'/pmsuser/index.php?r=Organization_flow/chartdata',
                        success : function(data)
                        {
                            alert(data);
                            //var redirect = base_url+'/pmsuser/index.php?r=Organization_flow/chartdata',
                            $().redirect(base_url+'/pmsuser/index.php?r=Organization_flow/chartdata', {'cluster_name': $(".get_cluster").find(':selected').val(), 'dept_name': $(".get_dept").find(':selected').val()});
        ...
        <div id="emp_id_list"></div>
                ...
                <div id="err" style="display: none"></div>
                    ...
                    <div class="col-md-12"><br>
                        <div class="row">
                            <div class="col-md-12">
                            <!-- <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Organization_flow/chartdata"><input type="button" id="modal-954288" role="button" class="btn" data-toggle="modal" value="View" style="border: 1px solid rgb(76, 158, 217);float: right;"></a> -->
                            <input type="button" role="button" class="btn" id="chart_create" value="View" style="border: 1px solid rgb(76, 158, 217);float: right;">
                            <div class="col-md-3">
