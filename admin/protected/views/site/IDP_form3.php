                    ...
                    <div class="modal-dialog">
                        <div class="modal-content"> 
                         <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=IDP/IDP_Mid_approvegoal_list"><button type="button" class="btn border-blue-soft" id="redirect_to_master">Master Page</button></a>
                                </div> 
                        </div>
                    </div>
                   </div>
