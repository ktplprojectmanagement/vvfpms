                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                                  if (isset($IDP_data['0']['rel_target_date'])) { $rel2 = explode(';',$IDP_data['0']['rel_target_date']); ?>
                                                                       <input class="form-control target_date3" <?php echo $set_flag1; ?> type="text" value="<?php echo $rel2[0]; ?>" id="target_date3">
                                                                   <?php }
                                                                    else
                                                                    { ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <?php
                                                                  if (isset($IDP_data['0']['rel_target_date']) && $IDP_data['0']['rel_target_date']!='') { $rel2 = explode(';',$IDP_data['0']['rel_target_date']); ?>
                                                                       <input class="form-control target_date4" <?php echo $set_flag1; ?> type="text" value="<?php echo $rel2[1]; ?>" id="target_date4">
                                                                   <?php }
                                                                    else
                                                                    { ?>
