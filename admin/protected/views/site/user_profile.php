                    ...
                    <div class="profile">
                        <div class="portlet box red" style="border:1px solid #4C87B9;" >
                            ...
                            <div class="portlet-body tabs-below">
                                <div class="tab-content"><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Resetpassword"><button class="btn btn-primary" style="float:right">Reset Password</button></a>
