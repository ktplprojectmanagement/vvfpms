                                    ...
                                    <div class="dashboard-stat2 "style="background-color:#efefef;">
                                        <div class="display">
                                            <div class="number">
                                                ...
                                                <small style="font-weight: unset;font-size:15px;"  id="idp_Submitted" class="chk_user_status"><a style="color: green;" href="javascript:doSomething();">Total Head Count</a></small>
                                            </div>
                ...
                <div class="dashboard-stat2 " style="background-color:#efefef">
                    <div class="display">
                        <div class="number">
                            <h3 class="font-blue-sharp">
<?php $yer_sub=0;
if(isset($yearEnd_rev_all) ){
         
$yer_sub=$yearEnd_rev_all;
}
...
<?php 
$appr_yer=0;
if(isset($yearEnd_rev2) ){
$appr_yer=$yearEnd_rev2;
}
...
<?php 
$pend_appr=0;
if(isset($yearEnd_rev1) ){
 $pend_appr=$yearEnd_rev1;          
