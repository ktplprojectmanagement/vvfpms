                                ...
                                <div class="invoice">
                                    <div class="row invoice-logo">
                                        <div class="col-xs-6 invoice-logo-space">
                                            <img src="http://kritvainvestments.com/pmsuser/assets/pages/img/login/kritva_logo.png" alt="KRITVA TECHNOLOGY PVT.LTD." style="max-width: 8%;"> </div>
                                    </div>
                                    <hr/>
                                    <div class="row">  
                                    ...
                                    ?>                        
                                       <p>Welcome <?php if(isset($mail_data['0']['Emp_fname'])) { echo $mail_data['0']['Emp_fname']."  ".$mail_data['0']['Emp_lname']; } ?>,</p>
                                       <p>
                                           You can use the following credentials to access the PMS portal to view information covering your performance, account and appraisal process.
                                            ...
                                            <p>
                                            Your username is : <?php if(isset($mail_data['0']['Emp_fname'])) { echo $mail_data['0']['Email_id']; }?><br>
