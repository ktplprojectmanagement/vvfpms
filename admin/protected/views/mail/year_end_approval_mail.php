...
<hr >
  ...
  Please be informed the final year goalsheet for year <label><?php echo date('Y').'-'.date('Y', strtotime('+1 year')); ?></label>  has been approved.</span> Kindly login to PMS Online to review the same and further actions.<br/>

<span> Please click the link below to check status:<br>
  <a href="https://vvf.kritva.in/index.php/PMSlogin/yearenda">https://vvf.kritva.in/index.php/Login</a>
