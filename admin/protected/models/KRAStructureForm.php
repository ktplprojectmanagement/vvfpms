...
class KRAStructureForm extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('No_of_KPI, KRA_category,minimum_kpi', 'required'),
			
			array('No_of_KPI', 'match', 'pattern'=>'/^([0-9]{1,10})$/', 'message'=>'Please Enter only numbers'),
			array('minimum_kpi', 'match', 'pattern'=>'/^([0-9]+)$/', 'message'=>'Please Enter only numbers'),
			// array('maximum_kpi', 'match', 'pattern'=>'/^([0-9]+)$/', 'message'=>'Please Enter only numbers'),
