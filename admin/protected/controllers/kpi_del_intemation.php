...
<div class="container">
  <div class="logo">
<img src="http://kritvainvestments.com/pmsuser/assets/pages/img/login/kritva_logo.png" alt="KRITVA TECHNOLOGY PVT.LTD." style="max-width: 8%;">
<hr >
  </div>
  Dear <label><?php if(isset($mail_data['0']['Emp_fname'])) { echo $mail_data['0']['Emp_fname'].' '.$mail_data['0']['Emp_lname']; }?></label>,<br/>

  Please be informed that the KPI <?php if(isset($del_kpi)) { echo $del_kpi; }  ?> has been deleted from below KRA : <br/>
                                        ...
                                        <div class="portlet box border-blue-soft bg-blue-soft" id="output_div_<?php echo $kpi_data['0']["KPI_id"]; ?>">
                                           <div class="portlet-title">
                                                <div class="caption" style="font-weight:bold; font-size:18px; color: black;">                                                  
                                                    <label id="total_<?php echo $cnt_num; ?>" style="display: none"><?php echo $kpi_data['0']['target']; ?></label>
                                                   <?php echo $kpi_data['0']['KRA_category']; ?><?php echo "(".$kpi_data['0']['target'].")"; ?></div>
                                            </div>
...
<span> Click on the link below to check the status:<br>
  <a href="http://kritvainvestments.com/pmsuser/index.php?r=Login">http://kritvainvestments.com/pmsuser/index.php?r=Login</a>
