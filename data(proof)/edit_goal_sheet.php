           ...
           j(".date_pickup").attr('value',$(this).val());
                    ...
                    $("body").on('click','.del_kpi',function(){
                        ...
                        $("body").on('click','#del_goal_set',function(){
                            ...
                            datatype : 'html',
                            data : data,
                            url : base_url+'/pmsuser/index.php?r=Setgoals/kpi_del1',
                            success : function(data)
                            {
                                //alert(id_value[1]);
                ...
                'extra_kpi' : 1,
                        ...
                        var base_url = window.location.origin;
                         $.ajax({
                                ...
                                datatype : 'json',
                                data : selected_unit,
                                url : base_url+'/pmsuser/index.php?r=Setgoals/gettarget_value1',
                                success : function(data)
                                { 
                       ...
                       $("body").on('click','.del_kra_kpi',function(){
                            ...
                            $("#continue_del_krakpi").unbind('click').click(function(){
                                $("#show_spin_kpi").css('display','block');
                                    ...
                                    type : 'post',
                                    data : data,
                                    url : base_url+'/pmsuser/index.php?r=Setgoals/krakpi_del',
                                    success : function(data)
                                    {
                        ...
                        if(error[kra_id_value1[j]] == '')
                          { 
                                            ...
                                            $.ajax({
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+'/pmsuser/index.php?r=Setgoals/update_emp_kpi',
                                                success : function(data)
                                                {
//alert(data);
                      ...
                      if($("#compare_designation").text() == 1 && $("#project_title1").val() == '' || $("#project_title1").val().length>500)
                        ...
                        else
                        {
                          ...
                          $.ajax({
                              ...
                              'datatype' : 'html',
                              'data' : detail_data,
                              'url' : base_url+'/pmsuser/index.php?r=IDP/save_data_final',
                            success : function(data)
                            {
                               $("#show_spin2").css('display','block');
                                var data = {
                                ...
                                $.ajax({
                                    ...
                                    datatype : 'html',
                                    data : data,
                                    url : base_url+'/pmsuser/index.php?r=Setgoals/final_goal_review1',
                                    success : function(data)
                                    {
save_detail_pdf();
                                                    ...
                                                    $("#show_spin1").show();jQuery("#static").modal('hide');
                                                     var base_url = window.location.origin;
                                                        $.ajax({
                                                            ...
                                                            datatype : 'html',
                                                            data : data,
                                                            url : base_url+'/pmsuser/index.php?r=Setgoals/goalapproved',
                                                            success : function(data)
                                                            {
                                                                //alert(data);
                        ...
                        $("#err").text(error);
                         ...
                         { 
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/pmsuser/index.php?r=Setgoals/savekpi1',
                                success : function(data)
                                {
                                    //alert(data);
                                    if (data == "Success")
