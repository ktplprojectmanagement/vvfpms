...
--
-- Host: localhost:3306
-- Generation Time: Jan 06, 2017 at 03:19 PM
...
INSERT INTO `AMC_details` (`name`, `mobile_number`, `email_id`, `registration_code`, `product`, `instrument_month`, `AMC_id`, `staff_id`, `address`, `representative`, `amc_reference_id`, `id`) VALUES
('HDFC Mutual Fund', '9768478040', 'hjghj@ghjghj.co', 'E-11111', 'FD', '10', 6728060, '568669', 'Jghjhgj', 'Ghjhg', 9, 1),
('Rec', '7894561231', 'dfdsf@gfdg.com', 'SADSA', 'Asdsad', '12', 9845484, '607363', 'Sadsadfghgfh', '', 0, 2),
('Fsdfds', '7894125631', 'fsdfds@ghjgj.com', 'DSFD', 'DSFDSF', '20', 6684954, '607363', 'Fsdfds', 'Abc', 0, 3),
('Ffdsfds', '7894561238', 'fsdfd@dfs.co', 'DSFSD', 'FDFDS', '10', 1934435, '568669', 'Dsfsdfsd', 'Sdfdsf', 0, 4),
('Ffdsfds', '7894561238', 'fsdfd@dfs.co', 'DSFSD', 'FDFDS', '10', 1934435, '568669', 'Dsfsdfsd', 'Sdfdsf', 0, 5),
('Ffdsfds', '7894561238', 'fsdfd@dfs.co', 'DSFSD', 'FDFDS', '10', 1934435, '568669', 'Dsfsdfsd', 'Sdfdsf', 0, 6),
('Ffdsfds', '7894561238', 'fsdfd@dfs.co', 'DSFSD', 'FDFDS', '10', 1934435, '568669', 'Dsfsdfsd', 'Sdfdsf', 0, 7),
('Dfdfds', '7894561236', 'fdsfd@fgfdg.co', 'HJKHJK', 'HJHGJG', '', 5310397, '568669', 'Hgfhgfh', 'Dsfds', 0, 8),
('Apollo', '7894561236', 'sdfds@fghfg.co', 'FGFGFD', 'GI', '', 4761600, '568669', 'Fghgfhgf', 'FDSFDS', 0, 9),
('Axis Mutual Fund', '7894561236', 'gdfgfd@sdfsd.vo', 'FGFDG', 'MF', '', 5338148, '568669', 'Fgjfgjgfj', 'Gfdg', 53, 10),
('REC', '9768478040', 'gdfgfd@fdsf.co', 'FDSF', 'Bonds', '', 5647242, '568669', 'Gdfgdfgf', 'Rec', 0, 11),
('Apolo New', '9768478040', 'gfhgf@gfdg.co', 'GHGFH', 'GI', '', 8148401, '568669', 'Hgfhg', 'Hgfhg', 0, 12);

-- --------------------------------------------------------

--
-- Table structure for table `Bussiness_associate`
--

CREATE TABLE IF NOT EXISTS `Bussiness_associate` (
  ...
  `ba_commision` float NOT NULL,
  `commission_staff_id` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `Bussiness_associate`
--

INSERT INTO `Bussiness_associate` (`name`, `address`, `mobile_number`, `email_id`, `DOB`, `gender`, `PAN_number`, `category`, `BA_id`, `telephone`, `state`, `city`, `zipcode`, `staff_id`, `transaction_id`, `ba_commision`, `commission_staff_id`) VALUES
('Kritva', 'GDFGF', '9768478040', 'dsfds@fdgfd.com', '2016-04-26', 'male', 'ABCDE1234K', 'FGFDG', '123456', '222-222-2222', 'Maharashtra', 'Mumbai', 410210, '568669', 7082950, 675675, '568669'),
('Jkjh', 'Jytujytjyt', '9768478040', 'kjhk@gtgytr.com', '0000-00-00', 'female', 'ABCDE1234J', 'Gddfgfdgdf', '3598526', '11-111', 'Yjyjyt', 'Yjytjy', 410206, '', 0, 0, ''),
('New', 'GHJHG', '7894561236', 'fgdfgfd@fghf.co', '0000-00-00', 'male', 'ABCDE1234K', 'HJHGJ', '4004004', '222-222-2222', 'JGHJGH', 'JHGJHG', 410206, '607363', 0, 0, ''),
('Gfdgfd', 'Hfghgfhg', '7895623145', 'dsadsa@gjghj.com', '0000-00-00', 'female', 'ABCDE1236K', 'Gfhgfh', '5125446', '11-111', 'Gfhgfh', 'Ghgfh', 410206, '568669', 0, 0, ''),
('WERER', 'JHGJHGJ', '7894561236', 'ghfghf@fhgfgh.co', '0000-00-00', 'female', 'ABCDE1452L', 'JHGJHGJ', '5636387', '11-11', 'Maharashtra', 'Mumbai', 410206, '568669', 0, 0, ''),
('Any', 'FDSFDS', '7894561236', 'fdsf@dfgdg.co', '0000-00-00', 'male', 'ABCDD1236L', 'FDSFSDF', '5753142', '22-222', 'Maharashtra', 'Pune', 410206, '568669', 0, 0, ''),
('Sadsad', 'DFGDFG', '7894561236', 'dasdas@ghjgh.co', '0000-00-00', 'female', 'ABCDE1234J', 'GDFGFD', '9449366', '11-1111', 'DFGFD', 'DFGFD', 410206, '568669', 0, 0, '');
...
INSERT INTO `customer` (`name`, `address`, `mobile_number`, `telephone_number`, `email_id`, `DOB`, `gender`, `PAN_number`, `customer_type`, `dependency_type`, `cust_id`, `state`, `city`, `zipcode`, `exist_from`, `edit_date`, `staff_id`, `BA_id`, `id`, `nationality`) VALUES
('Fdgf', 'SDFSDF', '7777777777', '11-111', 'jghjgh@dsf.com', '0000-00-00', 'female', 'ABCDE1236J', 'SDFDSF', 'BA', '1218970', 'Maharashtra', 'Mumbai', 410206, '2016-04-28', '0000-00-00', '568669', '123456', 12, 'Indian'),
('bvcbv', 'GFDGFDG', '8888888888', '22-22', 'gfdgfd@gfdgfd.co', '0000-00-00', 'female', 'ABCDE1111K', 'GFDGFDG', 'BA', '4910382', 'DFGFDGFD', 'GDFGFD', 410206, '2016-04-28', '0000-00-00', '568669', '3598526', 13, ''),
('hgfhgf', 'HGJGHJ', '8888888888', '11-111', 'hgfhgf@dfgfd.co', '0000-00-00', 'female', 'ABCDE1236H', 'HGJHGJ', 'Retail', '2309426', 'HGJGH', 'GJHG', 410206, '2016-04-28', '0000-00-00', '568669', '', 14, ''),
('gfhgf', 'FDSFD', '9999999999', '11-111', 'hgfh@fdgfd.co', '0000-00-00', 'male', 'AVGHJ1452K', 'FSDFDSF', 'BA', '9305757', 'DSFDSF', 'SDFSDF', 410206, '2016-04-28', '0000-00-00', '568669', '4004004', 15, ''),
('jhgj', 'jkjhk', '7888888888', '55-55', 'ghjgh@dfgf.co', '0000-00-00', 'male', 'AVGHJ4785L', 'FSDFSDF', 'Retail', '8959373', 'jhkjhk', 'FSDF', 410206, '2016-04-28', '0000-00-00', '568669', '', 16, ''),
('Fsdfds', 'Gdfgdfg', '7444444444', '22-22', 'dsfsd@ghjgjh.co', '0000-00-00', 'female', 'ACFDE1234K', 'Fdgfdg', 'Retail', '7766275', 'Maharashtra', 'Thane', 410206, '2016-04-29', '0000-00-00', '568669', '', 17, ''),
('Fsdfds', 'YRTYTRYT', '7894561236', '11-11', 'sdfds@sdrwer.com', '0000-00-00', 'female', 'ABCDE1236K', 'YTRYT', 'Retail', '7130878', 'Maharashtra', 'Nagpur', 410206, '2016-04-29', '0000-00-00', '568669', '', 18, ''),
('Mebhjgj', 'HGFHGHG', '9768478040', '', 'dfgdfg@ghghj.com', '0000-00-00', 'female', 'ABCDE1256K', 'HGFHGF', 'Retail', '1735405', 'Maharashtra', 'Sangli', 410206, '2016-05-11', '0000-00-00', '568669', '', 19, '');
...
CREATE TABLE IF NOT EXISTS `Instrument_details` (
  ...
  `commissional_payable` float NOT NULL,
  `renewable_status` varchar(10) NOT NULL,
  `renewable_period` int(11) NOT NULL,
...
INSERT INTO `Instrument_details` (`name`, `company_name`, `category`, `subcategory`, `code`, `established_date`, `commission_rate`, `commissional_payable`, `renewable_status`, `renewable_period`, `instrument_id`, `id`, `staff_id`, `product`, `month_period`, `insurance_type`) VALUES
('HDFC Balanced Fund - Dividend Option', 'HDFC Mutual Fund', 'ARN', 'None', 'HDFC-PD/41858', '26/04/2017', 15, 12, 'yes', 2, '5623093', 4, '568669', 'MF', 0, ''),
('Axis', 'HDFC Mutual Fund', 'Dsdfds', 'Fgfdgfd', 'DDDDDD', '11/12/1333', 11, 10, 'no', 0, '4914534', 5, '568669', 'FD', 15, ''),
('54 rec', 'Rec', 'HGFHFG', 'HFGHFGH', '', '11/11/1111', 15, 10, 'yes', 12, '7084881', 6, '607363', '', 6, ''),
('HDFC Arbitrage Fund -Direct Plan - Growth Option', 'HDFC Mutual Fund', 'hfghg', 'gfhfgh', '', '11/12/1252', 44, 10, 'no', 0, '9871197', 10, '568669', 'FD', 15, ''),
('Health Insurance', 'Apollo', 'Health', 'Health', '', '11/12/1020', 10, 10, 'yes', 10, '7543288', 13, '568669', 'GI', 0, 'Health'),
('rec', 'REC', 'jhkj', 'jhkjh', '', '11-May-2016', 10, 6, 'no', 0, '7887972', 16, '568669', 'Bonds', 0, ''),
('jhhgjh', 'Apolo New', 'ghjh', 'jhgj', '', '12-May-2016', 10, 5, 'no', 0, '7165060', 17, '568669', 'GI', 0, 'Home'),
('Axis Children''s Gift Fund - Lock in - Growth', 'Axis Mutual Fund', 'category', 'category', '', '04-May-2016', 10, 0, 'no', 0, '2581224', 18, '568669', 'MF', 0, '');
...
INSERT INTO `login` (`id`, `name`, `age`) VALUES
(1, 'fdgh', 0);
...
CREATE TABLE IF NOT EXISTS `nav` (
  ...
  `ISIN Div Payout/ ISIN Growth` varchar(300) NOT NULL,
  `sign` varchar(50) NOT NULL,
  `Scheme Name` varchar(200) NOT NULL,
  `Net Asset Value` float NOT NULL,
  `Repurchase Price` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `access_allow` varchar(30) NOT NULL,
...
INSERT INTO `role` (`id`, `role_name`, `access_allow`, `role_id`) VALUES
(1, 'Developer', 'All', 1),
(2, 'Sale', 'All', 2);
...
CREATE TABLE IF NOT EXISTS `Transaction` (
  ...
  `instrument_renew_status` varchar(10) NOT NULL,
  `renewable_period` varchar(20) NOT NULL,
  `BA_id` varchar(15) NOT NULL,
  `transaction_id` varchar(50) NOT NULL,
  `id` int(11) NOT NULL,
  `staff_id` varchar(15) NOT NULL,
  `product` varchar(100) NOT NULL,
  `nominee_number` int(11) NOT NULL,
  `nominee_names` varchar(300) NOT NULL,
  `account_holder_status` varchar(10) NOT NULL,
  `account_holder_names` varchar(300) NOT NULL,
  `account_holder_pan` varchar(300) NOT NULL,
  `profit_percent` float NOT NULL,
  `folio_number` varchar(100) NOT NULL,
  `transaction_period` float NOT NULL,
  `insurance_type` varchar(200) NOT NULL
...
INSERT INTO `Transaction` (`cust_id`, `instrument_id`, `Instrument_type`, `transaction_type`, `amount`, `dependency_type`, `start_date`, `end_date`, `instrument_renew_status`, `renewable_period`, `BA_id`, `transaction_id`, `id`, `staff_id`, `product`, `nominee_number`, `nominee_names`, `account_holder_status`, `account_holder_names`, `account_holder_pan`, `profit_percent`, `folio_number`, `transaction_period`, `insurance_type`) VALUES
('1458282', '3907204', 'Rec', 'QUATERLY', 60000, 'BA', '15-Apr-2016', '05-May-2016', 'no', '', '123456', '4653668', 21, '568669', 'Bonds', 0, 'DFGDFG,jhgjhg', '1', 'own', 'own', 6, '4444', 0, ''),
('1218970', '5623093', 'HDFC Arbitrage Fund ', 'Fixed Deposite', 500, 'Retail', '15-Apr-2016', '01-May-2016', 'yes', '12', '123456', '7082954', 22, '568669', 'FD', 0, 'DADASDAS', '1', 'own', 'own', 12, '222', 12, ''),
('1458282', '5623093', 'HDFC Arbitrage Fund ', 'LUMPSUM', 100000, 'Retail', '01-May-2016', '05-May-2016', 'no', '', '', '7199660', 24, '568669', 'MF', 0, 'DFDSFDS', '3', 'drtgrtr,FDSFDSsadsadsa', 'ABCDE1235K,ABCFR1452I', 10.6575, '1111', 0, ''),
('1458282', '4914534', 'Axis Enhanced Arbitr', 'Ggf', 15000, 'Retail', '10-May-2016', '10-May-2016', 'no', '', '', '5761238', 25, '568669', 'MF', 0, 'yuyuytuy', '1', 'own', 'own', 0, '', 12, ''),
('1458282', '5623093', 'HDFC Arbitrage Fund ', 'SIP', 20000, 'Retail', '10-May-2016', '10-May-2016', 'no', '', '', '6714007', 26, '568669', 'MF', 0, 'hgfhgf', '1', 'own', 'own', 18.515, '', 12, ''),
('1458282', '4914534', 'Axis Enhanced Arbitr', 'DDSAD', 10000, 'Retail', '11-May-2016', '11-May-2016', 'no', '', '', '1736941', 27, '568669', 'MF', 0, 'ioioiuo', '1', 'own', 'own', 10.6816, '', 0, ''),
('1458282', '5623093', 'HDFC Arbitrage Fund ', 'TYTRY', 1500, 'Retail', '01-May-2016', '11-May-2016', 'no', '', '', '7735028', 28, '568669', 'MF', 0, 'yuyuy', '1', 'own', 'own', 18.518, '', 0, ''),
('1458282', '5623093', 'HDFC Arbitrage Fund ', 'YJYJY', 1500, 'Retail', '11-May-2016', '11-May-2016', 'no', '', '', '6771441', 29, '568669', 'MF', 0, 'ghgfhgf', '1', 'own', 'own', 18.518, '', 0, ''),
('1458282', '5623093', 'HDFC Arbitrage Fund ', 'NBMNB', 4114, 'Retail', '11-May-2016', '11-May-2016', 'no', '', '', '4347027', 30, '568669', 'MF', 0, 'liliul', '1', 'own', 'own', 18.518, '', 0, ''),
('1218970', '9871197', 'HDFC Arbitrage Fund ', 'SIP', 1000, 'Retail', '14-Jan-2016', '13-May-2016', 'no', '', '123456', '8617968', 31, '568669', 'MF', 0, 'fgfgfd', '1', 'own', 'own', 18.54, '', 0, ''),
('1218970', '7543288', 'Health Insurance', '', 4000, 'Retail', '01-May-2016', '11-May-2016', 'no', '', '', '9109441', 37, '568669', 'GI', 0, 'gfhgf', '1', 'own', 'own', 0, '', 0, ''),
('1218970', '2581224', 'Axis Children''s Gift', 'SIP', 2000, 'Retail', '02-Jan-2016', '31-Mar-2017', 'no', '', '123456', '8735082', 38, '568669', 'MF', 0, 'gdgdfg', '1', 'own', 'own', 10.2807, '', 0, '---Select---'),
('1218970', '9871197', 'HDFC Arbitrage Fund ', 'FIXED', 20000, 'Retail', '01-May-2016', '', 'no', '', '123456', '2320165', 39, '568669', 'FD', 0, 'ghgfhg', '1', 'own', 'own', 10, '', 15, '---Select---');
...
INSERT INTO `user_data` (`user_id`, `user_name`, `mobile_number`, `user_email`, `gender`, `role`, `telephone_number`, `state`, `city`, `zipcode`, `address`, `password`) VALUES
('403767', 'Gdfgfd', '7777777777', 'fdgfdg@fdgdf.co', '', '', '', 'Gfdg', 'Fgdgdf', 410206, 'Fdgdfg', '25f9e794323b453885f5181f1b624d0b'),
('477659', 'Gfhfgh', '7777777777', 'gfhgfh@dfsgfdg.co', '', '', '', 'Ghgfh', 'Gfhfg', 410206, 'Fghgfh', '8be58eaf0a08dbb6e819502bc4b06d6d'),
('507527', 'Monica', '9768478040', 'dxfdsf@hgfh.co', '', 'Developer', '', 'Ddfds', 'Fdgfds', 410206, 'Fgfdg', '25f9e794323b453885f5181f1b624d0b'),
('568669', 'Monica', '9768478040', 'mssadafule@gmail.com', '', '1', '', 'Maharashtra', 'Mumbai', 410206, 'Mumbai', 'e10adc3949ba59abbe56e057f20f883e'),
('607363', 'Monica', '9768478040', 'sfsdfd@hgfh.com', '', '', '', 'Ddsfds', 'Ffddsd', 410206, 'Ddfdsfd', '25f9e794323b453885f5181f1b624d0b'),
('870424', 'Ghjhgj', '7777777777', 'ghjghj@dsfsd.co', '', '', '', 'Jhgjhg', 'Jhgjg', 410206, 'Hgjghj', 'fb3a5e909618a53392c8e6dc94d1d8e2');
...
--
-- Indexes for table `Bussiness_associate`
--
ALTER TABLE `Bussiness_associate`
...
--
-- Indexes for table `Instrument_details`
--
...
--
-- AUTO_INCREMENT for table `Instrument_details`
--
ALTER TABLE `Instrument_details`
